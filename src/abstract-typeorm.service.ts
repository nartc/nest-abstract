...
export class AbstractTypeOrmService<T extends AbstractEntity> extends AbstractCoreService<T> {
    ...
    public async delete(id: IdType): Promise<DeleteResultType<T>> {
        return this._model.delete(this.getId(id)) as DeleteResultType<T>;
    }
